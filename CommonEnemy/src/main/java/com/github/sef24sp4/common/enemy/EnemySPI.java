...
public interface EnemySPI {
	 ...
	 * <p>
	 * Note the new enemy does not have any start coordinates and should be provided after, or it will assume the standard values (0,0) provided by {@link Coordinates}
	 *
